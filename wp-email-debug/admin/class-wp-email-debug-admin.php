 ...
 * @subpackage WP_Email_Debug/admin
 */
...
class WP_Email_Debug_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $wp_email_debug       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->wp_email_debug, plugin_dir_url( __FILE__ ) . 'css/wp-email-debug-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->wp_email_debug, plugin_dir_url( __FILE__ ) . 'js/wp-email-debug-admin.js', array( 'jquery' ), $this->version, false );
