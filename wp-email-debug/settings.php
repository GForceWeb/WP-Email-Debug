    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <label>
              <input type="radio" value="1" name="wpmdbug_scope" <?php echo ($scope) ? '': 'checked'; ?>/>
          ...
          <td>
            <table>
              <tbody>
                <tr>
                  <th colspan="2">
                    <input type="checkbox" id="selall" <?php echo (count($scopes) == count($plugins)) ? 'checked': ''; ?>/> Select All
                  </th>
                </tr>
